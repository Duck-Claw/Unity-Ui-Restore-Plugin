...
Use PSD Auto Slicer to export UI assets before restoring them in Unity.

PSD Auto Slicer:

https://github.com/Duck-Claw/PSD-Auto-Slicer#%E4%B8%AD%E6%96%87

This plugin uses the PNG files and `export_manifest.json` generated by PSD Auto Slicer as its input.
...
使用这个 Unity 插件之前，需要先用 PSD Auto Slicer 从 PSD 中导出 UI 资源。

PSD Auto Slicer：

https://github.com/Duck-Claw/PSD-Auto-Slicer#%E4%B8%AD%E6%96%87

本插件会读取 PSD Auto Slicer 生成的 PNG 文件和 `export_manifest.json`，并在 Unity 中还原 UGUI 界面。
