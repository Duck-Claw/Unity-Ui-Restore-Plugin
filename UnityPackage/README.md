...
Use PSD Auto Slicer to export UI assets from a PSD before using this Unity plugin.

PSD Auto Slicer:

https://github.com/Duck-Claw/PSD-Auto-Slicer#%E4%B8%AD%E6%96%87

This Unity plugin restores UI from the PNG files and `export_manifest.json` generated by PSD Auto Slicer.
